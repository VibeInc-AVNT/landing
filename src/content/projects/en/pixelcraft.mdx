...
Built with Astro and subtle JavaScript animations, the site delivers smooth transitions and engaging visual experiences. The design approach focused on creating a minimalist interface that allows the artistic work to take center stage.
